        ...
        <div class="container1">
            ...
            <div class="column">
                <div class="image-box"><?php
                  $sql = "SELECT name FROM ngo_inf WHERE  uid = (SELECT id from credentials WHERE username = '$user')"; //'$user'
                  $query = mysqli_query($mysqli, $sql);
                  $rows = mysqli_num_rows($query);
                    if($rows > 0){
                      $sql1 = "SELECT image FROM ngo_inf WHERE uid =(SELECT id from credentials where username = '$user')";
            ...
            <div class="column">
                ...
                <?php 
                  ...
                  $rows = mysqli_num_rows($query);
                    if($rows == 0){
                        echo "You have not yet registered for a fundraiser";
                    }
                    else{ ?>

                <label for="name">Name: <?php 
                          $sql = "SELECT * FROM ngo_inf WHERE uid =(SELECT id from credentials where username = '$user')";
