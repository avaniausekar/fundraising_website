...
if (isset($_SESSION['session_user'])) {
  ...
  $cat_res = mysqli_query($mysqli, "select * from donatee_info where status = 0");

  //ngo
  $sql2 = "SELECT * from ngo_inf order by uid desc";
  $res2 = mysqli_query($mysqli,$sql2);
  $cat_res2 =  mysqli_query($mysqli, "select * from ngo_inf where status = 0");
}
?>
    ...
    <div class="container">
      <div class="column">
        ...
        while ($row = mysqli_fetch_assoc($cat_res)) {
          ...
          <table>
            ...
            <tr>
              <td><img src="/uploads/<?php echo ($row['verification_doc']) ?> " style="width:300px;height: 300px" /></td>
            </tr>
          ...
          <form action="patient_update.php" method="post">
            ...
            <input type="radio" id="ver1" name="verify" value="1">
            <label for="ver1">Accept</label><br>
            <input type="radio" id="ver2" name="verify" value="2">
            <label for="ver2">Reject</label><br>
      ...
      <div class="column">
        ...
        while ($row = mysqli_fetch_assoc($cat_res2)) {
          ...
          <form action="ngo_update.php" method="post">
            <input type="hidden" id="uid" name="uid" value=<?php echo ($row['uid']) ?>>
            <input type="radio" id="ver1" name="verify" value="1">
            <label for="ver1">Accept</label><br>
            <input type="radio" id="ver2" name="verify" value="2">
